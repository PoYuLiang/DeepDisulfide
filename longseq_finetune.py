...
NEW_MODEL_PATH = "./all_res_model_with_noise_ft.pt"
OLD_MODEL_PATH = "./lightning_logs/all_res_model_with_noise/all_res_model_with_noise.pt"
TRAIN_DATA_FOLDER = "./data/longseq_training"
